...
start /min "TEMPSENSE Backend [port 3001]" cmd /c "cd /d "%~dp0backend" && title TEMPSENSE Backend [port 3001] && color 0A && :loop && echo. && echo   TEMPSENSE Backend Server && echo   ======================== && echo. && set SMTP_DECRYPTION_KEY=Xgtfgz-Mcrrc&& call npm start && timeout /t 2 >nul && goto loop"
